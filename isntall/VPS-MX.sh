...
function_verify () {
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/lacasitamx/VPSMX/master/Version-x")
...
wget -O /usr/bin/SOPORTE https://www.dropbox.com/s/jsk6l2jrz3suso6/so8.5x?dl=0 &>/dev/null
...
wget -O /etc/versin_script_new https://raw.githubusercontent.com/lacasitamx/VPSMX/master/Version-x &>/dev/null
...
echo 'echo ""' >> .bashrc
#
echo 'figlet ":VPS-CA:"|lolcat' >> .bashrc
#echo 'echo "" '>> .bashrc
...
case $1 in
"menu"|"message.txt"|"ID"|"name")ARQ="${SCPdir}/";; #Menu
